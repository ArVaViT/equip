            ...
            >
              ...
              <div className="min-w-0 flex-1 space-y-2">
                ...
                {/* Timeline of the request lifecycle so the admin knows
                    ...
                    list shows the row). */}
                <dl className="grid grid-cols-1 gap-x-4 gap-y-1 text-xs text-ink-muted/90 sm:grid-cols-2">
                  {cert.requested_at && (
                  ...
                  {cert.requested_at && (
                    <div
                      className="hidden text-xs text-ink-muted/60 sm:col-span-2 sm:block"
              ...
              <div className="flex shrink-0 flex-col items-stretch justify-center gap-2 sm:w-44">
                ...
                <p className="text-xs leading-tight text-ink-muted/80">
