...
_CATALOG: Final[dict[LocaleCode, dict[str, str]]] = {
    "en": {
        ...
        "email.invitation.eyebrow": "{org} · invitation",
        "email.invitation.fact.first_session": "First session",
        "email.invitation.fact.teacher": "Teacher",
        "email.invitation.fact.lessons_value": "{count}, 75 minutes each",
        "email.invitation.session_at": "{date}, {eastern} Eastern ({pacific} Pacific)",
    ...
    "ru": {
        ...
        "email.invitation.eyebrow": "{org} · приглашение",
        "email.invitation.fact.first_session": "Первое занятие",
        "email.invitation.fact.teacher": "Преподаватель",
        "email.invitation.fact.lessons_value": "{count}, по 75 минут",
        "email.invitation.session_at": "{date}, {eastern} по восточному ({pacific} по тихоокеанскому)",
    ...
    "de": {
        ...
        "email.invitation.eyebrow": "{org} · Einladung",
        "email.invitation.fact.first_session": "Erste Sitzung",
        "email.invitation.fact.teacher": "Dozent",
        "email.invitation.fact.lessons_value": "{count}, je 75 Minuten",
        "email.invitation.session_at": "{date}, {eastern} Ostküstenzeit ({pacific} Pazifikzeit)",
    ...
    "uk": {
        ...
        "email.invitation.eyebrow": "{org} · запрошення",
        "email.invitation.fact.first_session": "Перше заняття",
        "email.invitation.fact.teacher": "Викладач",
        "email.invitation.fact.lessons_value": "{count}, по 75 хвилин",
        "email.invitation.session_at": "{date}, {eastern} за східним ({pacific} за тихоокеанським)",
