...
def build_system_prompt(*, source_locale: LocaleCode, target_locale: LocaleCode) -> str:
    ...
    return (
        ...
        "it.\n"
        "2d. An EQA token (for example EQA7f3c19a05be24d81) stands for a "
        "copyright notice, a source line, an author credit or an ISBN. "
        "Copy it through character for character, in the same place. Do "
        "not translate it, do not move it, do not drop it, and never "
        "write an attribution of your own in its place.\n"
