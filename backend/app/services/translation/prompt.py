...
def build_system_prompt(*, source_locale: LocaleCode, target_locale: LocaleCode) -> str:
    ...
    return (
        ...
        f"prose, into the words a {tgt} reader would meet. Where the phrase "
        f"is how a {src} Bible renders a verse, use how a {tgt} Bible "
        "renders the same verse, not a transliteration of the source.\n"
